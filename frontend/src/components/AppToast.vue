...
import { usePlatToast } from '@ds/composables/usePlatToast'
import type { AppVariant } from '@ds/types/ui'
import type { SharedProps } from '@/types/shared'

// Composables ........................................................
const page = usePage<SharedProps>()
const { state, success, danger } = usePlatToast()
  ...
  <Teleport to="body">
    <div class="ds-toast-region" aria-live="polite" aria-atomic="false">
      <TransitionGroup name="toast">
        <div v-for="toast in state.toasts" :key="toast.id" class="ds-toast-item">
